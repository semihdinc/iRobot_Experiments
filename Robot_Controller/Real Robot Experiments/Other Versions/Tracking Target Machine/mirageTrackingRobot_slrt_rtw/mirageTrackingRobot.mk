...
MODEL           = mirageTrackingRobot
MODULES         = mirageTrackingRobot_capi.c mirageTrackingRobot_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = mirageTrackingRobot.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\sd0016\Desktop\TRACKI~2
S_FUNCTIONS     = xpcusbvideoin.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = mirageTrackingRobotlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = mirageTrackingRobot_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\mirageTrackingRobot_slrt_rtw
