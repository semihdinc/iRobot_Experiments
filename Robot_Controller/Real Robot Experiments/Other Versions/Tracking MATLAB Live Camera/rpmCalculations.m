...
ind1 = 1:5;     %Negative part of the curve (  <0 )
ind2 = 7:11;   %Positive part of the curve ( >=0 )
...
subplot(1,2,1);plot(fL1,vL(ind1),PWM(ind1));
subplot(1,2,2);plot(fR2,vR(ind2),PWM(ind2));hold all;
subplot(1,2,2);plot(fR1,vR(ind1),PWM(ind1));


disp(['PWM_L = ',num2str(fL1.p1),'*vL^3 + '...
                ,num2str(fL1.p2),'*vL^2 + '...
                ,num2str(fL1.p3),'*vL + '...
                ,num2str(fL1.p4),';']);
