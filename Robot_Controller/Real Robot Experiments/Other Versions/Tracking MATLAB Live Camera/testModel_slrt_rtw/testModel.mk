...
MODEL           = testModel
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c testModel_capi.c xpc_datatype_ground.c 
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\sd0016\Desktop\TRACKI~3
S_FUNCTIONS     = 
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
...
MODELLIB                  = testModellib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = testModel_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\testModel_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\sd0016\Desktop\TESTMO~1
