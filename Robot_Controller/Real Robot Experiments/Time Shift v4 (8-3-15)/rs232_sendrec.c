/* $Revision: 1.4.4.5 $ $Date: 2009/12/22 18:55:44 $ */
...
static void mdlOutputs(real_T *y, const real_T *x, const real_T *u, SimStruct *S, int_T tid)
{
		...
		if (!rs232ports[port]) {
			printf("        RS232 I/O-receive Error: chosen COM-port not initialized\n");
			return;
		}
