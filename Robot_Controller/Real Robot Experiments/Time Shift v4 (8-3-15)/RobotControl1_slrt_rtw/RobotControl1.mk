...
MODEL           = RobotControl1
MODULES         = RobotControl1_capi.c RobotControl1_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_sfcn_helper.c rt_zcfcn.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = RobotControl1.mk
...
S_FUNCTIONS     = rs232bsend.c rs232brec.c rs232setup.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 0
...
MODELLIB                  = RobotControl1lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = RobotControl1_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\RobotControl1_slrt_rtw
