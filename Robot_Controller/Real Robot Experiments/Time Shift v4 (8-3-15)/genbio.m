...
bio(1).dim=[1,1];
bio(1).sigWidth=1;
bio(1).sigAddress='&gen_B.longitude';
bio(1).ndims=2;
bio(1).size=[];
...
bio(2).dim=[1,1];
bio(2).sigWidth=1;
bio(2).sigAddress='&gen_B.latitude';
bio(2).ndims=2;
bio(2).size=[];
...
bio(3).dim=[1,1];
bio(3).sigWidth=1;
bio(3).sigAddress='&gen_B.altitude';
bio(3).ndims=2;
bio(3).size=[];
